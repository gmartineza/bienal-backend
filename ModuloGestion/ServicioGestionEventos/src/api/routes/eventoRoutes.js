 ...
 * @access Público
 */
router.post('/createEvent', upload.single('imagen'), celebrate(crearEventoSchema), eventoController.crearEvento);
 ...
 * @access Público
 */
router.put('/update/:id', upload.array('imagenes'), celebrate(actualizarEventoSchema), eventoController.actualizarEvento);
